...
rm -f *.${IMAGE_TYPE}
#####
$CONVERTER 1 29979245800.0 ${MODE_ANGLE_AND_ENERGY} distribuzione.ppg ${PX_COL} ${PY_COL} ${PZ_COL} ${ID_PARTICLE_COL} ${WEIGHT_COL_DISTR_FILE}
mv conv.distribuzione.ppg distribuzione.ENAN.ppg
#####
$CONVERTER 1 1 ${MODE_BIN1D} distribuzione.ENAN.ppg ${ENERGY_COL} ${NBIN_ENERGY} ${EMIN} ${EMAX} ${WEIGHT_COL_ENAN_FILE}
mv conv.distribuzione.ENAN.ppg distribuzione.initialENERGY.binned.ppg
$CONVERTER 1 1 ${MODE_BIN1D} distribuzione.ENAN.ppg ${ANGLE_COL} ${NBIN_ANGLE} ${THETAMIN} ${THETAMAX} ${WEIGHT_COL_ENAN_FILE}
mv conv.distribuzione.ENAN.ppg distribuzione.initialANGLE.binned.ppg
$CONVERTER 1 1 ${MODE_BIN1D} distribuzione.ppg ${X_COL} ${NBIN_X} ${XMIN} ${XMAX} ${WEIGHT_COL_DISTR_FILE}
mv conv.distribuzione.ppg distribuzione.initialPOSITION.binned.ppg
$CONVERTER 1 1 ${MODE_BIN2D} distribuzione.ENAN.ppg ${ENERGY_COL} ${NBIN_ENERGY} ${EMIN} ${EMAX} ${ANGLE_COL} ${NBIN_ANGLE} ${THETAMIN} ${THETAMAX} ${WEIGHT_COL_ENAN_FILE}
mv conv.distribuzione.ENAN.ppg distribuzione.initialHEATMAP.binned.ppg
#####
...
printf "#!/gnuplot\n" >> ${GNUPLOT_FILE_EN}
printf "FILE_IN_1='distribuzione.initialENERGY.binned.ppg'\n" >> ${GNUPLOT_FILE_EN}
printf "FILE_IN_2='test.initialENERGY.binned.ppg'\n" >> ${GNUPLOT_FILE_EN}
...
printf "\n" >> ${GNUPLOT_FILE_EN}
printf "FILE_IN_2 u ((\$1+\$2)*0.5):(\$3*%s*%s) w histeps lt 1 lc rgb 'dark-green' lw 3 t 'spectrum after first iris',\\" "${WEIGHT2}" "${SUBSAMPLE_FACTOR}" >> ${GNUPLOT_FILE_EN}
printf "\n" >> ${GNUPLOT_FILE_EN}
...
printf "#!/gnuplot\n" >> ${GNUPLOT_FILE_AN}
printf "FILE_IN_1='distribuzione.initialANGLE.binned.ppg'\n" >> ${GNUPLOT_FILE_AN}
printf "FILE_IN_2='test.initialANGLE.binned.ppg'\n" >> ${GNUPLOT_FILE_AN}
...
printf "\n" >> ${GNUPLOT_FILE_AN}
printf "FILE_IN_2 u ((\$1+\$2)*0.5):(\$3*%s*%s) w histeps lt 1 lc rgb 'dark-green' lw 3 t 'spectrum after first iris',\\" "${WEIGHT2}" "${SUBSAMPLE_FACTOR}" >> ${GNUPLOT_FILE_AN}
printf "\n" >> ${GNUPLOT_FILE_AN}
...
printf "#!/gnuplot\n" >> ${GNUPLOT_FILE_POS}
printf "FILE_IN_1='distribuzione.initialPOSITION.binned.ppg'\n" >> ${GNUPLOT_FILE_POS}
printf "FILE_IN_2='test.initialPOSITION.binned.ppg'\n" >> ${GNUPLOT_FILE_POS}
...
printf "\n" >> ${GNUPLOT_FILE_POS}
printf "FILE_IN_2 u ((\$1+\$2)*5):(\$3*%s*%s) w histeps lt 1 lc rgb 'dark-green' lw 3 t 'spectrum after first iris',\\" "${WEIGHT2}" "${SUBSAMPLE_FACTOR}" >> ${GNUPLOT_FILE_POS}
printf "\n" >> ${GNUPLOT_FILE_POS}
...
printf "FILE_OUT='firstiris.initialheatmap.${IMAGE_TYPE}' \n" >> ${GNUPLOT_FILE_HEATMAP}
printf "set terminal ${IMAGE_TERMINAL} truecolor enhanced size ${SIZEX},${SIZEY} \n" >> ${GNUPLOT_FILE_HEATMAP}
printf "set output FILE_OUT \n" >> ${GNUPLOT_FILE_HEATMAP}
printf "set title 'dN/(dEd{/Symbol W}) (MeV^{-1} mrad^{-1})' \n" >> ${GNUPLOT_FILE_HEATMAP}
printf "set xlabel 'E (MeV)' \n" >> ${GNUPLOT_FILE_HEATMAP}
...
chmod 775 ${GNUPLOT_FILE_HEATMAP}
printf "#!/gnuplot \n" >> ${GNUPLOT_FILE_HEATMAP}
printf "FILE_IN_1='distribuzione.initialHEATMAP.binned.ppg' \n" >> ${GNUPLOT_FILE_HEATMAP}
printf "FILE_OUT='distribuzione.initialheatmap.${IMAGE_TYPE}' \n" >> ${GNUPLOT_FILE_HEATMAP}
printf "set terminal ${IMAGE_TERMINAL} truecolor enhanced size ${SIZEX},${SIZEY} \n" >> ${GNUPLOT_FILE_HEATMAP}
printf "set output FILE_OUT \n" >> ${GNUPLOT_FILE_HEATMAP}
printf "set title 'dN/(dEd{/Symbol W}) (MeV^{-1} mrad^{-1})' \n" >> ${GNUPLOT_FILE_HEATMAP}
printf "set xlabel 'E (MeV)' \n" >> ${GNUPLOT_FILE_HEATMAP}
...
printf "FILE_OUT='firstiris.initialenan.${IMAGE_TYPE}' \n" >> ${GNUPLOT_FILE_ENAN}
printf "set terminal ${IMAGE_TERMINAL} truecolor enhanced size ${SIZEX},${SIZEY} \n" >> ${GNUPLOT_FILE_ENAN}
printf "set output FILE_OUT \n" >> ${GNUPLOT_FILE_ENAN}
printf "set title 'Energy-angle correlation plot' \n" >> ${GNUPLOT_FILE_ENAN}
printf "set xlabel 'E (MeV)' \n" >> ${GNUPLOT_FILE_ENAN}
...
chmod 775 ${GNUPLOT_FILE_ENAN}
printf "#!/gnuplot \n" >> ${GNUPLOT_FILE_ENAN}
printf "FILE_IN_1='distribuzione.ENAN.ppg' \n" >> ${GNUPLOT_FILE_ENAN}
printf "FILE_OUT='distribuzione.initialenan.${IMAGE_TYPE}' \n" >> ${GNUPLOT_FILE_ENAN}
printf "set terminal ${IMAGE_TERMINAL} truecolor enhanced size ${SIZEX},${SIZEY} \n" >> ${GNUPLOT_FILE_ENAN}
printf "set output FILE_OUT \n" >> ${GNUPLOT_FILE_ENAN}
printf "set title 'Energy-angle correlation plot' \n" >> ${GNUPLOT_FILE_ENAN}
printf "set xlabel 'E (MeV)' \n" >> ${GNUPLOT_FILE_ENAN}
